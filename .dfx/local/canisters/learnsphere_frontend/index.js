...
import { idlFactory } from './learnsphere_frontend.did.js';
export { idlFactory } from './learnsphere_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LEARNSPHERE_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./learnsphere_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the learnsphere_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./learnsphere_frontend.did.js")._SERVICE>}
 */
export const learnsphere_frontend = createActor(canisterId);
