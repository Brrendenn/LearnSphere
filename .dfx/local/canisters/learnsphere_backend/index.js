...
import { idlFactory } from './learnsphere_backend.did.js';
export { idlFactory } from './learnsphere_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LEARNSPHERE_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./learnsphere_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the learnsphere_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./learnsphere_backend.did.js")._SERVICE>}
 */
export const learnsphere_backend = createActor(canisterId);
